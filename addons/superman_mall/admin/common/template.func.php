...
function template($filename, $flag = TEMPLATE_DISPLAY) {
	global $_W;
    if (Agent::isMobile()) {
        $source = MODULE_ROOT . "/admin/themes/default/mobile/{$filename}.html";
        $compile = MODULE_ROOT . "/data/tpl/admin/themes/default/mobile/{$filename}.tpl.php";
    } else {
        $source = MODULE_ROOT . "/admin/themes/default/{$filename}.html";
        $compile = MODULE_ROOT . "/data/tpl/admin/themes/default/{$filename}.tpl.php";
    }
	if(!is_file($source)) {
