...
class Superman_mall_doWebAd extends Superman {
	public function __construct() {
		parent::__construct();
        parent::init();
        $this->check_user_permission('superman_mall_menu_ad');
		$this->exec();
	}
    public function exec() {
        global $_W, $_GPC;
        $act = in_array($_GPC['act'], array('display', 'post', 'delete', 'setattr', 'content'))?$_GPC['act']:'display';
        $positions = M::t('superman_mall_ad')->get_positions();
        if ($act == 'display') {
