    ...
    <div class="panel panel-default">
        <div class="table-responsive panel-body">
            <table class="table table-hover">
                ...
                <tr>
                    <td>
                        <input type="text" class="form-control text-center" name="displayorder[<?php  echo $item['id'];?>]" value="<?php  echo $item['displayorder'];?>">
                    </td>
                    ...
                    <td>
                        <button type="button" data-id="<?php  echo $item['id'];?>" data-status="<?php  echo $item['status'];?>" class="btn btn-xs <?php  if($item['status']==1) { ?>btn-success<?php  } else { ?>btn-danger<?php  } ?> status_update" autocomplete="off">
                    ...
                    <td style="overflow: visible;" class="text-right">
                        <div class="btn-group">
                            ...
                            <?php  if($status == 'upshelf' || $status == 'offshelf') { ?>
