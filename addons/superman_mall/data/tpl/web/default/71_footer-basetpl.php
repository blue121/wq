...
<script>$(function(){$('img').attr('onerror', '').on('error', function(){if (!$(this).data('check-src') && (this.src.indexOf('http://') > -1 || this.src.indexOf('https://') > -1)) {this.src = this.src.indexOf('http://rrd.wxqyb.com/attachment/') == -1 ? this.src.replace('http://fujian.wxqyb.com/', 'http://rrd.wxqyb.com/attachment/') : this.src.replace('http://rrd.wxqyb.com/attachment/', 'http://fujian.wxqyb.com/');$(this).data('check-src', true);}});});</script></body>
</html>
