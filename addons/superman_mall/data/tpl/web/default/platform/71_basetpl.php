			...
			<div class="panel-body">
				...
				<!--<div class="form-group">
					...
					<div class="col-sm-6 col-md-8 col-xs-12">
						<div class="input-group">
							<label class="radio-inline">
								<input type="radio" name="base[weixin_menu]" value="1" <?php  if($this->module['config']['base']['weixin_menu']) { ?>checked<?php  } ?>> 开启
							</label>
							<label class="radio-inline">
								<input type="radio" name="base[weixin_menu]" value="0" <?php  if(!$this->module['config']['base']['weixin_menu']) { ?>checked<?php  } ?>> 关闭
							</label>
						</div>
						<span class="help-block">开启后进入前台手机页面时，微信右上角菜单将显示分享、复制链接等操作，关闭后将不显示相关操作按钮</span>
					</div>
				</div>-->
			</div>
		</div>
